"""Regression checks for the harbor-mob-offline-lens casebook."""
...
from casebook.harness import assert_expected, harbor_mob_offline_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_mob_offline_lens_summary(), assert_expected())
